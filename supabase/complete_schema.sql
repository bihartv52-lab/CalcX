-- ============================================
-- COMPLETE CALCX DATABASE SCHEMA
-- ============================================
...
CREATE TABLE IF NOT EXISTS rooms (
  ...
  current_media_url TEXT, -- For synced content
  media_position BIGINT DEFAULT 0, -- Playback position in milliseconds
  media_playing BOOLEAN DEFAULT FALSE,
  created_at TIMESTAMP WITH TIME ZONE DEFAULT NOW(),
  updated_at TIMESTAMP WITH TIME ZONE DEFAULT NOW()
);
